...
import { HomePageCarousel } from '@core/ui/components';
  ...
  return (
    <Box p={10}>
      ...
      <Box p={10}>
        ...
        <HomePageCarousel data={newCategoryLaunches} hideArrow />
        <Divider className={styles.dividers} />
        ...
        <HomePageCarousel data={appliances} hideArrow />
        <Divider className={styles.dividers} />
        ...
        <HomePageCarousel data={UXluxury} hideArrow />
        <Divider className={styles.dividers} />

        {/* HOME REPAIRS */}
        <Heading className={styles.headings}>Home Repairs</Heading>
        <HomePageCarousel data={homerepairs} hideArrow />
        <Divider className={styles.dividers} />
      </Box>
    </Box>
  );
